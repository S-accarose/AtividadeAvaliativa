...
function criarCardPublicacao(pub) {
    ...
    card.innerHTML = `
        ...
        <div class="card-body corpo-publicacao">
            ...
            <button class="btn btn-danger btn-sm">Excluir publicação</button>
        </div>
    `;
    ...
    if (usuarioLogado && usuarioLogado.isAdm) {
    const botaoExcluir = document.createElement("button");
    botaoExcluir.className = "btn btn-danger btn-sm mt-3";
    botaoExcluir.textContent = "Excluir publicação";
    ...
    const cardBody = card.querySelector(".corpo-publicacao");
